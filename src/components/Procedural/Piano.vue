...
async function initWebGPU() {
  ...
  try {
    ...
    // Define piano key vertices in JavaScript (rectangular prism) with white color and normals per face
    const vertices = new Float32Array([
      // Front face normal (0,0,1)
      -0.75, -0.15,  0.025, 1.0, 1.0, 1.0, 0.0, 0.0, 1.0,
       0.75, -0.15,  0.025, 1.0, 1.0, 1.0, 0.0, 0.0, 1.0,
       0.75,  0.15,  0.025, 1.0, 1.0, 1.0, 0.0, 0.0, 1.0,
      -0.75,  0.15,  0.025, 1.0, 1.0, 1.0, 0.0, 0.0, 1.0,
      ...
      -0.75,  0.15, -0.025, 1.0, 1.0, 1.0, 0.0, 1.0, 0.0,
      -0.75,  0.15,  0.025, 1.0, 1.0, 1.0, 0.0, 1.0, 0.0,
       0.75,  0.15,  0.025, 1.0, 1.0, 1.0, 0.0, 1.0, 0.0,
       0.75,  0.15, -0.025, 1.0, 1.0, 1.0, 0.0, 1.0, 0.0,
      ...
      // Right face normal (1,0,0)
       0.75, -0.15, -0.025, 1.0, 1.0, 1.0, 1.0, 0.0, 0.0,
       0.75,  0.15, -0.025, 1.0, 1.0, 1.0, 1.0, 0.0, 0.0,
       0.75,  0.15,  0.025, 1.0, 1.0, 1.0, 1.0, 0.0, 0.0,
       0.75, -0.15,  0.025, 1.0, 1.0, 1.0, 1.0, 0.0, 0.0,
