// /*
// Original Source: https://finance.yahoo.com/__finStreamer-proto.js

// This code is simply used to help decode the data sent by Yahoo.

// Some modification to make it typescript
// */
...
//       if (d instanceof root.quotefeeder.PricingData) return d;
...
//       }
//       if (d.time != null) {
//         if (util.Long) (m.time = util.Long.fromValue(d.time)).unsigned = false;
//         else if (typeof d.time === "string") m.time = parseInt(d.time, 10);
//         else if (typeof d.time === "number") m.time = d.time;
//         else if (typeof d.time === "object")
//           m.time = new util.LongBits(
//             d.time.low >>> 0,
//             d.time.high >>> 0
//           ).toNumber();
//       }
...
//         else if (typeof d.dayVolume === "number") m.dayVolume = d.dayVolume;
//         else if (typeof d.dayVolume === "object")
//           m.dayVolume = new util.LongBits(
//             d.dayVolume.low >>> 0,
//             d.dayVolume.high >>> 0
//           ).toNumber();
//       }
...
//         else if (typeof d.expireDate === "number") m.expireDate = d.expireDate;
//         else if (typeof d.expireDate === "object")
//           m.expireDate = new util.LongBits(
//             d.expireDate.low >>> 0,
//             d.expireDate.high >>> 0
//           ).toNumber();
//       }
...
//         if (util.Long)
//           (m.openInterest = util.Long.fromValue(d.openInterest)).unsigned =
//             false;
...
//           m.openInterest = new util.LongBits(
//             d.openInterest.low >>> 0,
//             d.openInterest.high >>> 0
//           ).toNumber();
//       }
...
//           m.optionsType = new util.LongBits(
//             d.optionsType.low >>> 0,
//             d.optionsType.high >>> 0
//           ).toNumber();
//       }
...
//         else if (typeof d.miniOption === "number") m.miniOption = d.miniOption;
//         else if (typeof d.miniOption === "object")
//           m.miniOption = new util.LongBits(
//             d.miniOption.low >>> 0,
//             d.miniOption.high >>> 0
//           ).toNumber();
//       }
...
//         else if (typeof d.lastSize === "number") m.lastSize = d.lastSize;
//         else if (typeof d.lastSize === "object")
//           m.lastSize = new util.LongBits(
//             d.lastSize.low >>> 0,
//             d.lastSize.high >>> 0
//           ).toNumber();
//       }
...
//         else if (typeof d.bidSize === "number") m.bidSize = d.bidSize;
//         else if (typeof d.bidSize === "object")
//           m.bidSize = new util.LongBits(
//             d.bidSize.low >>> 0,
//             d.bidSize.high >>> 0
//           ).toNumber();
//       }
...
//         else if (typeof d.askSize === "number") m.askSize = d.askSize;
//         else if (typeof d.askSize === "object")
//           m.askSize = new util.LongBits(
//             d.askSize.low >>> 0,
//             d.askSize.high >>> 0
//           ).toNumber();
//       }
...
//         else if (typeof d.priceHint === "number") m.priceHint = d.priceHint;
//         else if (typeof d.priceHint === "object")
//           m.priceHint = new util.LongBits(
//             d.priceHint.low >>> 0,
//             d.priceHint.high >>> 0
//           ).toNumber();
//       }
...
//         else if (typeof d.vol_24hr === "number") m.vol_24hr = d.vol_24hr;
//         else if (typeof d.vol_24hr === "object")
//           m.vol_24hr = new util.LongBits(
//             d.vol_24hr.low >>> 0,
//             d.vol_24hr.high >>> 0
//           ).toNumber();
//       }
...
//         if (util.Long)
//           (m.volAllCurrencies = util.Long.fromValue(
//             d.volAllCurrencies
//           )).unsigned = false;
...
//           m.volAllCurrencies = new util.LongBits(
//             d.volAllCurrencies.low >>> 0,
//             d.volAllCurrencies.high >>> 0
//           ).toNumber();
//       }
...
//               ? n.toNumber()
//               : n;
//         } else d.expireDate = o.longs === String ? "0" : 0;
//         d.openPrice = 0;
//         d.previousClose = 0;
//         d.strikePrice = 0;
//         d.underlyingSymbol = "";
...
//               ? n.toNumber()
//               : n;
//         } else d.openInterest = o.longs === String ? "0" : 0;
//         if (util.Long) {
//           var n = new util.Long(0, 0, false);
//           d.optionsType =
//             o.longs === String
...
//               ? n.toNumber()
//               : n;
//         } else d.optionsType = o.longs === String ? "0" : 0;
//         if (util.Long) {
//           var n = new util.Long(0, 0, false);
//           d.miniOption =
//             o.longs === String
...
//               ? n.toNumber()
//               : n;
//         } else d.miniOption = o.longs === String ? "0" : 0;
//         if (util.Long) {
//           var n = new util.Long(0, 0, false);
//           d.lastSize =
//             o.longs === String
...
//               ? n.toNumber()
//               : n;
//         } else d.lastSize = o.longs === String ? "0" : 0;
//         d.bid = 0;
//         if (util.Long) {
//           var n = new util.Long(0, 0, false);
//           d.bidSize =
...
//               ? n.toNumber()
//               : n;
//         } else d.bidSize = o.longs === String ? "0" : 0;
//         d.ask = 0;
//         if (util.Long) {
//           var n = new util.Long(0, 0, false);
//           d.askSize =
...
//               ? n.toNumber()
//               : n;
//         } else d.askSize = o.longs === String ? "0" : 0;
//         if (util.Long) {
//           var n = new util.Long(0, 0, false);
//           d.priceHint =
//             o.longs === String
...
//           d.expireDate =
//             o.longs === String ? String(m.expireDate) : m.expireDate;
//         else
//           d.expireDate =
//             o.longs === String
//               ? util.Long.prototype.toString.call(m.expireDate)
//               : o.longs === Number
//               ? new util.LongBits(
//                   m.expireDate.low >>> 0,
//                   m.expireDate.high >>> 0
...
//         d.openPrice =
//           o.json && !isFinite(m.openPrice) ? String(m.openPrice) : m.openPrice;
//       }
//       if (m.previousClose != null && m.hasOwnProperty("previousClose")) {
//         d.previousClose =
//           o.json && !isFinite(m.previousClose)
//             ? String(m.previousClose)
//             : m.previousClose;
//       }
...
//           d.openInterest =
//             o.longs === String ? String(m.openInterest) : m.openInterest;
//         else
//           d.openInterest =
//             o.longs === String
//               ? util.Long.prototype.toString.call(m.openInterest)
//               : o.longs === Number
//               ? new util.LongBits(
//                   m.openInterest.low >>> 0,
//                   m.openInterest.high >>> 0
//                 ).toNumber()
//               : m.openInterest;
//       }
...
//           d.optionsType =
//             o.longs === String ? String(m.optionsType) : m.optionsType;
//         else
//           d.optionsType =
//             o.longs === String
//               ? util.Long.prototype.toString.call(m.optionsType)
//               : o.longs === Number
//               ? new util.LongBits(
//                   m.optionsType.low >>> 0,
//                   m.optionsType.high >>> 0
//                 ).toNumber()
//               : m.optionsType;
//       }
...
//           d.miniOption =
//             o.longs === String ? String(m.miniOption) : m.miniOption;
//         else
//           d.miniOption =
//             o.longs === String
//               ? util.Long.prototype.toString.call(m.miniOption)
//               : o.longs === Number
//               ? new util.LongBits(
//                   m.miniOption.low >>> 0,
//                   m.miniOption.high >>> 0
...
//           d.lastSize =
//             o.longs === String
//               ? util.Long.prototype.toString.call(m.lastSize)
//               : o.longs === Number
//               ? new util.LongBits(
//                   m.lastSize.low >>> 0,
//                   m.lastSize.high >>> 0
...
//           d.bidSize =
//             o.longs === String
//               ? util.Long.prototype.toString.call(m.bidSize)
//               : o.longs === Number
//               ? new util.LongBits(
//                   m.bidSize.low >>> 0,
//                   m.bidSize.high >>> 0
...
//           d.askSize =
//             o.longs === String
//               ? util.Long.prototype.toString.call(m.askSize)
//               : o.longs === Number
//               ? new util.LongBits(
//                   m.askSize.low >>> 0,
//                   m.askSize.high >>> 0
...
//       }
//       if (
//         m.circulatingSupply != null &&
//         m.hasOwnProperty("circulatingSupply")
//       ) {
//         d.circulatingSupply =
//           o.json && !isFinite(m.circulatingSupply)
//             ? String(m.circulatingSupply)
//             : m.circulatingSupply;
//       }
//       if (m.marketcap != null && m.hasOwnProperty("marketcap")) {
//         d.marketcap =
//           o.json && !isFinite(m.marketcap) ? String(m.marketcap) : m.marketcap;
//       }
//       return d;
//     };
...
//       if (!(r instanceof Reader)) r = Reader.create(r);
//       var c = l === undefined ? r.len : r.pos + l,
//         m = new root.quotefeeder.StaticData();
//       while (r.pos < c) {
//         var t = r.uint32();
//         switch (t >>> 3) {
//           case 1:
...
//       if (d instanceof root.quotefeeder.StaticData) return d;
...
//         d.closePrice =
//           o.json && !isFinite(m.closePrice)
//             ? String(m.closePrice)
//             : m.closePrice;
//       }
//       if (
//         m.fiftytwoWkMovingAvgPrice != null &&
//         m.hasOwnProperty("fiftytwoWkMovingAvgPrice")
//       ) {
//         d.fiftytwoWkMovingAvgPrice =
//           o.json && !isFinite(m.fiftytwoWkMovingAvgPrice)
//             ? String(m.fiftytwoWkMovingAvgPrice)
//             : m.fiftytwoWkMovingAvgPrice;
//       }
//       if (
//         m.twohundredDataMovingAvgPrice != null &&
//         m.hasOwnProperty("twohundredDataMovingAvgPrice")
//       ) {
//         d.twohundredDataMovingAvgPrice =
//           o.json && !isFinite(m.twohundredDataMovingAvgPrice)
//             ? String(m.twohundredDataMovingAvgPrice)
//             : m.twohundredDataMovingAvgPrice;
//       }
//       return d;
//     };
...
//       if (!(r instanceof Reader)) r = Reader.create(r);
//       var c = l === undefined ? r.len : r.pos + l,
//         m = new root.quotefeeder.PriceUpdate();
//       while (r.pos < c) {
//         var t = r.uint32();
//         switch (t >>> 3) {
//           case 1:
...
//       if (d instanceof root.quotefeeder.PriceUpdate) return d;
...
//       if (!(r instanceof Reader)) r = Reader.create(r);
//       var c = l === undefined ? r.len : r.pos + l,
//         m = new root.quotefeeder.StaticUpdate();
//       while (r.pos < c) {
//         var t = r.uint32();
//         switch (t >>> 3) {
//           case 1:
...
//       if (d instanceof root.quotefeeder.StaticUpdate) return d;
